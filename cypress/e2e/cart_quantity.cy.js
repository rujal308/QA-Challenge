...
//     beforeEach(() => {
//         cy.session('user', () => {
//           // You don't need to rewrite login/register steps.
//           // Cypress will reuse existing session.
//         });
...
//         // // Visit the site and go to products page
...
//         //add third product from kids> dress
